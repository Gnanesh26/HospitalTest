...
public class DoctorController {
    ...
    public ResponseEntity<String> getDoctorDetails(@RequestParam("id") int id) {
        String doctor = doctorService.getDoctorById(id);
        if (doctor == null) {
...
//                result *= -1;
    ...
    public ResponseEntity<List<Doctor>> getDoctorsByName(@RequestParam("name") String name) {
